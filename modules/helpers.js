...
export function statusBadgeClass(status) { const value = (status || "").toLowerCase(); return value === "reviewed" ? "badge-reviewed" : value === "flagged" ? "badge-flagged" : "badge-unreviewed"; }
export function relevanceBadgeClass(relevance) { return (relevance || "").toLowerCase() === "relevant" ? "badge-relevant" : "badge-unreviewed"; }
