...
export function saveHypothesisDraft(draft) {
  localStorage.setItem(STORAGE_KEYS.hypothesis, JSON.stringify(draft));
}
export function loadHypothesisDraft() {
